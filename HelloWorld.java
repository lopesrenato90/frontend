...
public class HelloWorld { // Aqui é criada a classe HelloWorld
     ...
     * void: modo protegido de um método, o qual não retornará qualque valor
     * main: nome do método "executor"
     * ((abre parênteses)): serve para declara o início das declarações de parâmetros de um método/fuunção
     * @param args
     ...
     */
    public static void main (String[] args) { // Aqui é criado método executor main
        System.out.println("Hello World!!!"); // Aqui é "impressa" uma linha com o texo "Hello World"
