...
/**
 * A classe TelaDeCadastro fornece uma interface gráfica para um formulário de cadastro.
 * Permite ao usuário inserir um nome, email e senha, e inclui um botão para submeter os dados.
 * O formulário realiza validações e interage com um banco de dados MySQL para armazenar os dados.
 */
public class TelaDeCadastro extends JFrame {
    ...
    // Label para exibir mensagens de notificação ao usuário
    private final JLabel lblNotificacoes;

    /**
     * Construtor da classe TelaDeCadastro.
     * Configura a interface gráfica e adiciona um ActionListener ao botão de cadastro.
     */
    ...
    /**
     * Formata um texto para exibição em HTML.
     * 
     * @param strTexto O texto a ser formatado.
     * @return O texto formatado em HTML.
     */
    ...
    /**
     * Ponto de entrada da aplicação. Cria uma instância da TelaDeCadastro e define a operação de fechamento da janela.
     * 
